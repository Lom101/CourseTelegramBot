...
public class UserBotService : IUserBotService
{
    ...
    private async Task ShowFaqInfoAsync(long chatId, CancellationToken cancellationToken)
    {
        var faqText = "❓ *Часто задаваемые вопросы:*\n\n" +
                      "1️⃣ *Для кого предназначен этот курс?*\n" +
                      "Курс рассчитан на новичков, желающих прокачать свои навыки в работе с командой.\n\n" +
                      "2️⃣ *Сколько длится курс?*\n" +
                      "Курс рассчитан на самостоятельное обучение. Вы можете пройти курс как за один день, так и за месяц.\n\n" +
                      "3️⃣ *Как записаться на курс?*\n" +
                      "Чтобы записаться на курс, напишите команду.\n\n" +
                      "4️⃣ *Будет ли доступ к материалам после окончания курса?*\n" +
                      "Да, доступ останется навсегда.\n\n" +
                      "5️⃣ *Каков формат занятий?*\n" +
                      "Курс разбит на несколько блоков. Блоки — на темы. Каждая тема предоставляет текстовую и аудиоинформацию для самостоятельного обучения. В конце каждого блока необходимо пройти итоговый тест для продолжения обучения.\n\n" +
                      "6️⃣ *Даёте ли доступ к обновлениям программы?*\n" +
                      "Да, бесплатно.";
