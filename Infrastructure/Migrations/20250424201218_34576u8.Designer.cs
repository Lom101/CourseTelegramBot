...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250424201218_34576u8")]
    partial class _34576u8
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entity.Block", b =>
                {
                    b.HasOne("Core.Entity.Test.Test", "FinalTest")
                        .WithMany()
                        .HasForeignKey("FinalTestId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
